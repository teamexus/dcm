...
urlpatterns = [
    ...
    path('dcmadmin_profile/', views.dcmadmin_profile, name='dcmadmin_profile'),
    ...
    path('change-dcmadmin-profile/', views.dcmadmin_change, name='dcmadmin_change'),
    ...
    path('add-doctor-picture/', views.add_doctor_pro_pic, name='add_doctor_pro_pic'),
    path('add-patient-pic/', views.add_patient_pic, name='add_patient_pic'),
    path('change-picture/', views.change_pro_pic, name='change_pro_pic'),
    path('change-doctor-picture/', views.change_doctor_pro_pic, name='change_doctor_pro_pic'),
    path('change-patient-pic(<int:pid>)', views.change_patient_pic, name='change_patient_pic'),

...
urlpatterns = [
    ...
    path('view_test_report/', views.view_test_report, name='view_test_report'),
    path('view_package_test_report/', views.view_package_test_report, name='view_package_test_report'),
    ...
    path('create_test_report(<int:aid>)', views.create_test_report, name='create_test_report'),
    path(' create_package_test_report(<int:aid>)', views.create_package_test_report, name='create_package_test_report'),
    ...
    path('update_prescription(<int:pid>)', views.update_prescription, name='edit_prescription_2'),
    path('prescription_detail(<int:pid>)', views.prescription_detail, name='prescription_detail'),
    path('doctor_appointment_details(<int:aid>)', views.doctor_appointment_details, name='doctor_appointment_details'),
    path('view_test/', views.view_test, name='view_test'),
    path('create_test/', views.create_test, name='create_test'),
    path('delete_test(<int:pid>)', views.delete_test, name='delete_test'),
    path('delete_test_report(<int:pid>)', views.delete_test_report, name='delete_test_report'),
    path('delete_package_test_report(<int:pid>)', views.delete_package_test_report, name='delete_package_test_report'),
    path('update_test/<pk>/', views.UpdateTest.as_view(), name='update_test'),
    path('update_test_report/<pk>/', views.UpdateTestReport.as_view(), name='update_test_report'),
    path('update_package_test_report/<pk>/', views.UpdatePackageTestReport.as_view(), name='update_package_test_report'),
